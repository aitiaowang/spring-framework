 ...
 *
 * <li> {@link PropertyOverrideConfigurer}用于“beanName.property = value”样式覆盖（将属性文件中的值推入bean定义）
 * <li> {@link PropertyPlaceholderConfigurer}用于替换“${...}“占位符（将属性文件中的值拉到bean定义中）
 * </ul>
 *
 ...
 * <p>
 * 通过覆盖{@link #convertPropertyValue}方法，可以在读入属性值后对其进行转换。例如，可以在处理加密值之前对其进行相应的检测和解密。
 *
...
public abstract class PropertyResourceConfigurer extends PropertiesLoaderSupport
	 ...
	 * <p>
	 * 针对给定bean工厂的{@linkplain #mergeProperties Merge}，{@linkplain #convertProperties convert}
	 * 和{@linkplain #processProperties process}属性。
	 * <p>
	 * 得到配置，将得到的配置转换为合适的类型，最后将配置内容告知BeanFactory
	 *
