 ...
 * 它可能是由彼此继承的多个原始bean定义创建的，通常注册为{@link GenericBeanDefinition GenericBeanDefinitions}。
 ...
 * <p>
 * 在配置阶段，根Bean定义也可以用于注册单个Bean定义。但是，从Spring 2.5开始，
