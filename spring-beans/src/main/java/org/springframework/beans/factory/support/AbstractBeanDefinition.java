 ...
 * <p>
 * 具体的完整{@link BeanDefinition}类的基类，排除了{@link GenericBeanDefinition}，
 ...
 * interface.
 * <p>
 * 自动连线常数与{@link org.springframework.beans.factory.config.AutowireCapableBeanFactory}接口中定义的常数匹配。
 *
 * @author Rod Johnson
...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * 用来表示一个bean是实例化依靠另外一个bean先实例化，对应bean属性 depend-on
	 */
	@Nullable
	 ...
	 * 将不考虑该bean，即她不会被考虑作为其他bean自动装配的候选者，
	 ...
	 *
	 * @param original the original bean definition to copy from  要复制的原始bean定义
	 */
	 ...
	 * 覆盖给定bean定义（可能是子级）中此bean定义（可能是从父子继承关系中复制的父）中的设置
	 * <ul>
	 ...
	 * 验证此bean定义
	 *
	 * @throws BeanDefinitionValidationException in case of validation failure  如果验证失败
	 */
