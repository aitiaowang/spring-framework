...
public abstract class BeanDefinitionReaderUtils {
	 ...
	 * <p>
	 * 为给定的父名称和类名称创建一个新的GenericBeanDefinition，如果已指定ClassLoader，则急于加载Bean类。
	 *
	...
	public static AbstractBeanDefinition createBeanDefinition(
		...
		if (className != null) {
			if (classLoader != null) {
				//如果classLoader不为空，则使用以传入的classLoader同一虚拟机加载类对象，否则只是记录class name
	 ...
	 * @param registry         the bean factory to register with    注册的bean工厂
	 * @throws BeanDefinitionStoreException if registration failed  注册失败
	 */
