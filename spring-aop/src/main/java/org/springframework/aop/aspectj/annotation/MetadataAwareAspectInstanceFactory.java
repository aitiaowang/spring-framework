 ...
 * <p>
 * {@link org.springframework.aop.aspectj.AspectInstanceFactory} 的子接口，它返回与AspectJ注释的类相关联的{@link AspectMetadata}。
 *
 ...
 * 但是由于AspectMetadata仅使用Java-5 {@link org.aspectj.lang.reflect.AjType}，因此我们需要拆分此子接口。
 *
 * @author Rod Johnson
 * @see AspectMetadata
