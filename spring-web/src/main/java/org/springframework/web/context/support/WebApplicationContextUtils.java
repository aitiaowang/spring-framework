...
public abstract class WebApplicationContextUtils {
	 ...
	 * 该根目录通常通过{@link org.springframework.web.context.ContextLoaderListener}加载。
	 *
	 * <p>Will rethrow an exception that happened on root context startup,
	 * to differentiate between a failed context startup and no context at all.
	 * <p>
	 * 将抛出在根上下文启动时发生的异常，以区分失败的上下文启动和根本没有上下文。
	 *
	 * @param sc the ServletContext to find the web application context for   ServletContext查找Web应用程序上下文
	 * @return the root WebApplicationContext for this web app, or {@code null} if none
	 * 此Web应用程序的根WebApplicationContext，如果没有，则为{@code null}
	 * @see org.springframework.web.context.WebApplicationContext#ROOT_WEB_APPLICATION_CONTEXT_ATTRIBUTE
	 */
	@Nullable
	 ...
	 *
	 * @param sc       the ServletContext to find the web application context for     查找此Web应用程序的自定义{@code WebApplicationContext}。
	 * @param attrName the name of the ServletContext attribute to look for  要查找的ServletContext属性的名称
	 * @return the desired WebApplicationContext for this web app, or {@code null} if none
	 * 此Web应用程序所需的WebApplicationContext，如果没有，则为{@code null}
	 */
	@Nullable
