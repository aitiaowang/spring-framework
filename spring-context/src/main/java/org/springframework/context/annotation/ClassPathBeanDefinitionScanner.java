 ...
 * 用给定的注册表（{@code BeanFactory} 或{@code ApplicationContext}注册相应的bean定义。
 *
 ...
 * <p>
 * 通过可配置的类型过滤器检测候选类。默认过滤器包括使用Spring的
 * {@link org.springframework.stereotype.Component @Component}，
 * {@link org.springframework.stereotype.Repository @Repository}，
 * {@link org.springframework.stereotype.Service @Service}或
 * {@link org.springframework.stereotype.Controller @Controller}构造。
 *
