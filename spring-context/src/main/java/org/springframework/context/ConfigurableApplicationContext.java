...
public interface ConfigurableApplicationContext extends ApplicationContext, Lifecycle, Closeable {
	 ...
	 * <p>
	 * 工厂中LoadTimeWeaver Bean的名称。如果提供了这样的bean，则上下文将使用临时的ClassLoader进行类型匹配，
	 ...
	 *
	 * @throws BeansException        if the bean factory could not be initialized  如果无法初始化bean工厂
	 ...
	 * 确定此应用程序上下文是否处于活动状态，即是否至少刷新一次且尚未关闭。
	 *
	 * @return whether the context is still active   上下文是否仍处于活动状态
	 * @see #refresh()
	 * @see #close()
	 * @see #getBeanFactory()
	 */
