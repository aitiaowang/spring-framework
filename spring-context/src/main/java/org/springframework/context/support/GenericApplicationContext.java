...
public class GenericApplicationContext extends AbstractApplicationContext implements BeanDefinitionRegistry {
	 ...
	 * 返回此上下文（作为ConfigurableListableBeanFactory）持有的单个内部BeanFactory。
	 */
	@Override
	 ...
	 * 注意： 您需要调用{@link #refresh()}来使用应用程序上下文语义(自动检测BeanFactoryPostProcessors等)初始化bean工厂及其包含的bean。
	 *
	 * @return the internal bean factory (as DefaultListableBeanFactory) 内部bean工厂(如DefaultListableBeanFactory)
	 */
